...
<style>
  ...
  *{ box-sizing: border-box; }
  ...
  .bolita{
    ...
    animation: vuelta 6s linear infinite;
  }
  ...
  .f1{ animation-duration: 5.2s; animation-delay: -1.4s; }
  .f2{ animation-duration: 7.1s; animation-delay: -4.8s; animation-direction: reverse;
       width: 5px; height: 5px; opacity: .9; }
  .f3{ animation-duration: 8.6s; animation-delay: -6.2s; width: 6px; height: 6px; }
  .p1{ animation-duration: 6.4s; animation-delay: -3.1s; animation-direction: reverse;
       width: 6px; height: 6px; opacity: .85; }
  .p2{ animation-duration: 9.3s; animation-delay: -7.6s; width: 5px; height: 5px; opacity: .75; }
