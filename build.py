...
<main class="plate">
  ...
  <figure class="portrait rise d4">
    <img src="@@BASE@@foto.webp" alt="Luciana De la Rosa Padilla"
...
<meta http-equiv="refresh" content="1; url=./cena/">
<p style="font-family: system-ui, sans-serif; padding: 2rem; text-align: center">
  Esta invitación está ahora en <a href="./cena/">cena/</a>.
</p>
"""
...
MENU_DATOS = {
    ...
    "nota":   "Esta noche cierro cinco años de circuitos, trasnochos y cálculos, "
              "y no quería celebrarlo sin ti.<br><br>Gracias por sentarte a esta mesa "
              "conmigo.",
    "cursos": [
        {
            "titulo": "Entrada",
        ...
        },
        {
            ...
            "platos": [
                ...
                ("Salmón del Pacífico en&nbsp;Beurre Blanc de&nbsp;Maracuyá",
                 "Camarón crocante sobre risotto de quinoa y crema de puerros y papa."),
                ("Tentáculos de pulpo Tako&nbsp;Japonés al estilo “Rincón”",
                 "Servidos con brunoise de vegetales y chimichurri, paprika ahumada, "
                 "papas criollas, limón amarillo y trío de espumas (alioli, garbanzo "
                 "y perejil)."),
            ],
        },
        {
...
def build():
    for pg in PAGINAS:
        ...
        carpeta = os.path.dirname(pg["archivo"])
        if carpeta:
